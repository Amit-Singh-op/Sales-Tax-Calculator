...
An additional 5% import duty is applied to all imported goods.
Sales tax is rounded up to the nearest 0.05.
The application outputs a receipt that includes the item description, price (including tax), total sales tax, and the total cost of the items.
